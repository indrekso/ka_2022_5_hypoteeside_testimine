...
Eelmises praktikumis uurisime ülesande 4.4 siseriiklike institutsioonide usaldamise taseme erinevust Eestis sõltuvalt sellest, kas inimesed tunnevad end diskrimineerituna või mitte. Uurisime erinevust aritmeetiliste keskmiste usaldusvahemike alusel ja leidsime, et usaldusnivool 95% saab erinevust väita küll, kusjuures usaldusvahemikud võimaldasid erinevust adekvaatsemalt hinnata kui seda ainult keskmiste alusel oleksime teinud. Uurige nüüd, millise tulemuseni keskmiste erinevuse kohta jõuaksime *t*-testi alusel (tehke *t*-test läbi kaalutud andmetega, järeldus tehke olulisuse nivool 0,05). 

Varasemast teame, et kui keskmiste usaldusvahemikud ei kattu, saab keskmiste erinevust väita ja sisulise järelduse tegemiseks otseselt mingit lisatesti tarvis ei ole. Seega antud juhul järeldus ei muutu (keskmine usalduse kahes grupis erineb), kuid püüdke *t*-testi tulemusi tõlgendada - kuidas see tõlgendus erineb keskmiste usaldusvahemike tõlgendusest? Lisaks, hinnake keskmiste erinevuse ulatust populatsioonis, arvutades selleks *t*-testi tulemuste põhjal *keskmiste erinevuse* usaldusvahemiku. Kuidas erineb see hinnang sellest, mida oleksite keskmiste erinevuse ulatuse kohta saanud öelda *keskmiste* usaldusvahemike võrdluse põhjal?
